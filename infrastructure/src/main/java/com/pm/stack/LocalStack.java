...
public class LocalStack extends Stack {
  ...
  public LocalStack(final App scope, final String id, final StackProps props) {
    ...
    String jwtSecret = System.getenv().getOrDefault("JWT_SECRET",
            "dev-only-insecure-secret-do-not-use-in-prod-0000000000000000");
    FargateService authService = createFargateService("AuthService", "auth-service", List.of(4005), authServiceDb, Map.of("JWT_SECRET", jwtSecret));
    ...
    FargateService patientService = createFargateService("PatientService", "patient-service", List.of(4000), patientServiceDb, Map.of(
            "BILLING_SERVICE_ADDRESS", "localhost.localstack.cloud", "BILLING_SERVICE_GRPC_PORT", "9001"
    ));
  ...
  public void createApiGatewayService() {
    ...
    ContainerDefinitionOptions.Builder containerOptions = ContainerDefinitionOptions
            ...
            .environment(Map
                    .of("SPRING_PROFILES_ACTIVE", "prod",
                            "AUTH_SERVICE_URL", "http://localhost.localstack.cloud:4005",
                            "PATIENT_SERVICE_URL", "http://localhost.localstack.cloud:4000"))
  ...
  private FargateService createFargateService(
    ...
    if (db != null) {
      envVars.put("SPRING_DATASOURCE_URL", "jdbc:postgresql://%s:%s/%s-db?sslmode=disable".formatted(
